...
`do2screen` v4.0 requires **Stata 16.1 or higher**. This is a breaking change from v3.x, which supported Stata 14+. The reason is that v4.0 uses [frames](https://www.stata.com/manuals/dframes.pdf) for internal data handling, which were introduced in Stata 16.
...
This inconsistency is preserved in v4.0 for backward compatibility.
