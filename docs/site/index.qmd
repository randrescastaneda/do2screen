...
# do2screen <span style="font-size:0.5em; color:#6c757d;">v4.0</span>
...
`do2screen` v4.0 uses Stata [frames](https://www.stata.com/manuals/dframes.pdf) for internal data handling.
:::
